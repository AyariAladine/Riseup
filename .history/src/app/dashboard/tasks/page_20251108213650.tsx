  ...
  if (viewMode === "board") {
    return (
      <div className="github-container">
        ...
        >
          <div style={{ display: 'flex', gap: '20px', overflowX: 'auto', paddingBottom: '32px', justifyContent: 'flex-start' }}>
            {columns.map((column) => {
              return (
                <DroppableColumn
                  key={column.id}
  ...
  return (
    <div
      ...
      style={{
        ...
        ...(isOver ? { outline: '2px solid rgba(88, 166, 255, 0.5)' } : {})
      }}
    >
      <div className="github-card" style={{ minHeight: '400px', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        {/* Column Header */}
