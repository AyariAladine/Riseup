  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        console.log('[Tasks] Fetch response:', res.ok, res.status);
        if (!res.ok) throw new Error("Failed to load tasks");
        const data = await res.json();
        console.log('[Tasks] Data received:', data);
        if (!mounted || !mountedRef.current) {
          console.log('[Tasks] Component unmounted, skipping update');
          return;
        }
        ...
        console.log('[Tasks] Setting tasks:', tasksWithStatus.length, 'tasks');
        ...
        console.log('[Tasks] Setting loading to false. mounted:', mounted, 'mountedRef:', mountedRef.current);
        if (mounted && mountedRef.current) {
          setLoading(false);
          console.log('[Tasks] Loading set to false!');
        }
      }
    })();
    return () => {
