  ...
  return (
    ...
    <aside className="github-sidebar" id="app-sidebar">
      <nav className="github-sidebar-nav">
        {items.map((it) => {
          const active = pathname === it.href || (it.href !== '/dashboard/home' && pathname.startsWith(it.href + '/'));
          return (
            <Link 
              key={it.href} 
              href={it.href} 
    ...
    <div className="github-backdrop" onClick={closeDrawer} />
    <style jsx global>{`
      /* GitHub-style sidebar drawer */
      .github-sidebar {
        position: fixed;
        top: 54px;
        left: 0;
      ...
      body[data-drawer='open'] .github-sidebar {
      ...
      body[data-drawer='open'] .github-backdrop {
        opacity: 1;
        pointer-events: auto;
        display: block;
      }
      /* Desktop: Always show sidebar, reserve space */
