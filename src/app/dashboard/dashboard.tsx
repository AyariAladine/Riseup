  ...
  return (
    <div className="github-container">
      ...
      <div className="github-dashboard-grid">
        <a href="/dashboard/home" className="github-card github-card-interactive">
        ...
        <a href="/learn" className="github-card github-card-interactive">
        ...
        <a href="/dashboard/assistant" className="github-card github-card-interactive">
        ...
        <a href="/dashboard/profile" className="github-card github-card-interactive">
