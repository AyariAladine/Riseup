  ...
  return (
    <div className="github-container">
      ...
      <div className="github-dashboard-grid">
        ...
        <Link href="/dashboard/reclamations" className="github-card github-card-interactive">
          <div className="github-card-icon github-card-icon-tickets" style={{ color: '#10B981' }}>
            <svg width="24" height="24" viewBox="0 0 16 16" fill="currentColor">
              <path d="M0 1.75C0 .784.784 0 1.75 0h12.5C15.216 0 16 .784 16 1.75v9.5A1.75 1.75 0 0114.25 13H8.06l-2.573 2.573A1.458 1.458 0 013 14.543V13H1.75A1.75 1.75 0 010 11.25v-9.5zM1.75 1.5a.25.25 0 00-.25.25v9.5c0 .138.112.25.25.25h2a.75.75 0 01.75.75v2.19l2.72-2.72a.75.75 0 01.53-.22h6.5a.25.25 0 00.25-.25v-9.5a.25.25 0 00-.25-.25H1.75zM5 5a1 1 0 100 2 1 1 0 000-2zm4 0a1 1 0 100 2 1 1 0 000-2zm3 1a1 1 0 11-2 0 1 1 0 012 0z"/>
            </svg>
          </div>
          <div className="github-card-content">
            <div className="github-card-title">Support Tickets</div>
            <div className="github-card-description">Get AI-powered support for technical issues and questions</div>
          </div>
          <div className="github-card-arrow">→</div>
        </Link>
